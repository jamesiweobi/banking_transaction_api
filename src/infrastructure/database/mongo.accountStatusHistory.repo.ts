...
import { IAccountStatusHistory } from '../../application/domain/accountStatusHistory';
...
export class MongoAccountStatusHistoryRepository implements IAccountStatusHistoryRepository {
  async createAccountStatus(AccountStatus: IAccountStatusHistory): Promise<IAccountStatusHistory> {
